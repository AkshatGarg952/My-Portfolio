...
const PortalOverlay = ({ onTimeStoneClick }) => {
  return (
    <svg className="portal-overlay" viewBox="0 0 455 549" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Resume */}
      <a href="https://drive.google.com/file/d/1bwvf893q7AOBTNOhUMqQGDLKGuG32LkL/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="portal-link">
